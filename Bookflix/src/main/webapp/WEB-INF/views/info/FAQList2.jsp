...
<body>
  ...
  <div class="ntcontainer">
    <table class="table table-bordered tbFAQ">
      ...
      <c:forEach items="${FaqList2}" var="FaqList2">
        <tr>
          <td>${FaqList2.faq_num}</td>
          <td>${FaqList2.faq_category}</td>
          <td><a
            href="/info/FAQ?faq_num=${FaqList2.faq_num}">${FaqList2.faq_title}</a></td>
        </tr>
      </c:forEach>
    </table>
    </div>
