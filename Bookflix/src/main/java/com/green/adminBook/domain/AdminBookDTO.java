...
public class AdminBookDTO {
  ...
  public Integer getE_book_thumbupcnt() {
    return e_book_thumbupcnt;
  }
  public void setE_book_thumbupcnt(Integer e_book_thumbupcnt) {
    this.e_book_thumbupcnt = e_book_thumbupcnt;
  }
