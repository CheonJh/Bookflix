...
public class SearchController {
  ...
  public static final int ROWSIZE = 12; // test: 4, 나중에 더미데이터 늘리고 12개씩으로 변환
  public static int startRow = 0; // 시작 로우 값

  // 검색 책 더보기 - offset, limit
  public static final int SEARCHROWSIZE = 8; // test: 4, 나중에 더미데이터 늘리고 8개씩으로 변환
  ...
  @ResponseBody
  public List<AdminBookDTO> ajaxSearch(@RequestParam(required = false) String keyword, HttpSession session, Model model)
      throws Exception {
